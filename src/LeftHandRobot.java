/**
 *  This is the LefttHandRobot class that extends the FacingRobot class
...
public class LeftHandRobot extends FacingRobot {
	...
	@Override
	/**
	 * This method chooses the Direction for the LeftHandRobot to move in the mazeGrid
	 * @return Direction
	 */
	...
	@Override
	/**
	 * This method makes the LeftHandRobot move in the direction of input parameter
	 * @param int direction
	 */
